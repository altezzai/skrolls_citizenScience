        ...
        <div className="flex flex-col items-center gap-10">
          <div className="flex w-8/12 flex-col gap-4 max-lg:w-3/4 max-md:w-11/12">
            ...
            <form action="" className="flex flex-col gap-2">
              ...
              {/* Login button */}
              <input
                className="flex w-full cursor-pointer select-none justify-center rounded-lg bg-primary py-2 text-base font-bold text-bg-secondary transition-all ease-in-out hover:bg-red-500"
                type="submit"
                value="Login"
              />
            </form>
